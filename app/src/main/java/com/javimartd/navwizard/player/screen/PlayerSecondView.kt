...
@Composable
fun PlayerSecondView(playerNavigator: PlayerNavigator) {
    Column(
        ...
        Text(
            ...
            text = "Player Second View",
            textAlign = TextAlign.Center,
            style = TextStyle(fontSize = 24.sp)
        )
        Button(
            colors = ButtonDefaults.buttonColors(backgroundColor = colorResource(id = R.color.teal_200)),
            onClick = { playerNavigator.actionNavigateForwardTo(PlayerNavigator.THIRD) }
        ) {
            Text(text = "Navigate Forward")
        }
        Button(
            colors = ButtonDefaults.buttonColors(backgroundColor = colorResource(id = R.color.teal_200)),
            onClick = { playerNavigator.actionPopUpTo() }
        ) {
            Text(text = "Action Pop Up To")
        }
        Button(
            colors = ButtonDefaults.buttonColors(backgroundColor = colorResource(id = R.color.teal_200)),
